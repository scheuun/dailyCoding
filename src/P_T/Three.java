...
public class Three {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(three.solution(new int[]{-2, 3, 0, 2, -5}));
        System.out.println(three.solution(new int[]{-3, -2, -1, 0, 1, 2, 3}));
        System.out.println(three.solution(new int[]{-1, 1, -1, 1}));
    }
}
